...
const UpdateGroupChatModal = ({ fetchMessages, fetchAgain, setFetchAgain }:Props) => {
  ...
  const handleRename = async () => {
    ...
    try {
      ...
      const { data } = await axios.put(
        `${import.meta.env.VITE_BACKEND_API}/api/chat/rename`,
        {
  ...
  const handleAddUser = async (user1:any) => {
    ...
    try {
      ...
      const { data } = await axios.put(
        `${import.meta.env.VITE_BACKEND_API}/api/chat/groupadd`,
        {
          chatId: selectedChat._id,
          userId: user1._id,
        },
  ...
  const handleRemove = async (user1:any) => {
    ...
    try {
      ...
      const { data } = await axios.put(
        `${import.meta.env.VITE_BACKEND_API}/api/chat/groupremove`,
        {
          chatId: selectedChat._id,
          userId: user1._id,
        },
